...
func TestMergeCSSFontStyle(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "numeric 500 keeps existing style", existing: fontstyle.Normal, weight: "500", style: "", want: fontstyle.Normal},
		{name: "numeric 600 maps to semibold", existing: fontstyle.Normal, weight: "600", style: "", want: fontstyle.Semibold},
		{name: "semibold plus italic", existing: fontstyle.Normal, weight: "600", style: "italic", want: fontstyle.SemiboldItalic},
		{name: "existing semibold gains italic", existing: fontstyle.Semibold, weight: "", style: "italic", want: fontstyle.SemiboldItalic},
		{name: "bold plus italic", existing: fontstyle.Normal, weight: "bold", style: "italic", want: fontstyle.BoldItalic},
		{name: "bold wins over semibold", existing: fontstyle.Bold, weight: "600", style: "", want: fontstyle.Bold},
