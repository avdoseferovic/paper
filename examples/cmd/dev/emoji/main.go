...
func main() {
	textFontBytes, err := os.ReadFile(examplepath.Repo("docs/assets/fonts/arial-unicode-ms.ttf"))
	if err != nil {
		panic(err)
	}
	...
	if emojiFontPath == "" {
		emojiFontPath = examplepath.Repo("docs/assets/fonts/arial-unicode-ms.ttf")
	}
