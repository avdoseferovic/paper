...
func (f *PDF) writeCompressedFileObject(content []byte) {
...
func (f *PDF) putAnnotationsAttachments() {
	// avoid duplication
...
func (f *PDF) putAttachmentAnnotationLinks(out *fmtBuffer, page int) {
