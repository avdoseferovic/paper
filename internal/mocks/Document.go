...
import (
	...
	metrics "github.com/avdoseferovic/paper/pkg/metrics"
...
func (_e *Document_Expecter) Merge(ctx interface{}, bytes interface{}) *Document_Merge_Call {
	return &Document_Merge_Call{Call: _e.mock.On("Merge", ctx, bytes)}
}
...
func (_e *Document_Expecter) Write(w interface{}) *Document_Write_Call {
	return &Document_Write_Call{Call: _e.mock.On("Write", w)}
}
