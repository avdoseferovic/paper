...
## GoDoc
* [constructor : NewQr](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/code#NewQr)
* [constructor : NewQrCol](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/code#NewQrCol)
* [constructor : NewQrRow](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/code#NewQrRow)
...
## Time Execution
[filename](../assets/text/qrgrid.txt  ':include :type=code')
