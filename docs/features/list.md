...
## GoDoc
* [interface : Listable](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/list#Listable)
* [list : Build](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/list#Build)
* [list : BuildFromPointer](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/list#BuildFromPointer)

## Code Example
[filename](../assets/examples/list/paper.go ':include :type=code')
