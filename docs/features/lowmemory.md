...
## Code Example
[filename](../assets/examples/lowmemory/paper.go  ':include :type=code')
...
## Test File
[filename](https://raw.githubusercontent.com/avdoseferovic/paper/master/test/paper/examples/lowmemory.json  ':include :type=code')