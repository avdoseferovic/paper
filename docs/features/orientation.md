...
`WithOrientation` sets the page orientation. paper defaults to **portrait** (taller than wide). Switching to **landscape** rotates the page 90°, making it wider than tall — useful for wide tables, timelines, or presentations.

## Usage notes

- When switching to landscape, paper swaps the page width and height automatically, so the grid still divides the (now wider) page correctly.
...
## GoDoc
* [builder : WithOrientation](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/config#CfgBuilder.WithOrientation)
