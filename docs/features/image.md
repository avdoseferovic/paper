...
## GoDoc
* [constructor : NewFromBytes](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#NewFromBytes)
* [constructor : NewFromBytesCol](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#NewFromBytesCol)
* [constructor : NewFromBytesRow](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#NewFromBytesRow)
* [constructor : NewFromFile](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#NewFromFile)
* [constructor : NewFromFileCol](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#NewFromFileCol)
* [constructor : NewFromFileRow](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#NewFromFileRow)
* [props : Rect](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/props#Rect)
* [component : BytesImage](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#BytesImage)
* [component : FileImage](https://pkg.go.dev/github.com/avdoseferovic/paper/pkg/components/image#FileImage)

## Code Example
[filename](../assets/examples/imagegrid/paper.go ':include :type=code')
