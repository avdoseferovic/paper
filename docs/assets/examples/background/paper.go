// Package background demonstrates drawing a full-page background image behind the content.
package background
...
// GetPaper builds the background example document.
...
// AddPage is part of the background example.
