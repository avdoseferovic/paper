...
## GoDoc
* [component : Col : WithStyle](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/components/col#Col.WithStyle)
* [component : Row : WithStyle](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/components/row#Row.WithStyle)
* [props : Cell](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/props#Cell)
...
## Test File
[filename](https://raw.githubusercontent.com/johnfercher/paper/master/test/paper/examples/cellstyle.json  ':include :type=code')