...
## GoDoc
* [component : Col : WithStyle](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/components/col#Col.WithStyle)
* [component : Row : WithStyle](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/components/row#Row.WithStyle)
* [props : Cell](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/props#Cell)
