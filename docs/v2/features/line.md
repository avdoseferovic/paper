...
## GoDoc
* [constructor : New](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/components/line#New)
* [constructor : NewCol](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/components/line#NewCol)
* [constructor : NewRow](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/components/line#NewRow)
* [props : Line](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/props#Line)
* [component : Line](https://pkg.go.dev/github.com/johnfercher/paper/v2/pkg/components/line#Line)
...
## Test File
[filename](https://raw.githubusercontent.com/johnfercher/paper/master/test/paper/examples/line.json  ':include :type=code')