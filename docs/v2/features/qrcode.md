...
## GoDoc
* [constructor : NewQr](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/components/code#NewQr)
* [constructor : NewQrCol](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/components/code#NewQrCol)
* [constructor : NewQrRow](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/components/code#NewQrRow)
* [props : Rect](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/props#Rect)
* [component : QrCode](https://pkg.go.dev/github.com/avdoseferovic/paper/v2/pkg/components/code#QrCode)
...
## Test File
[filename](https://raw.githubusercontent.com/avdoseferovic/paper/master/test/paper/examples/qrgrid.json  ':include :type=code')