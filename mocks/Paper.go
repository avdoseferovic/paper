...
func (_m *Paper) EXPECT() *Maroto_Expecter {
...
func (_m *Paper) FitlnCurrentPage(heightNewLine float64) bool {
...
func (_m *Paper) Generate() (core.Document, error) {
	ret := _m.Called()
...
// NewMaroto creates a new instance of Paper. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
